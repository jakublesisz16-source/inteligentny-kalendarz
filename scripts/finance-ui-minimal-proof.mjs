...
const checks = [
  ...
  ['Full category overview remains reachable', finance.includes('Wszystkie kategorie') && finance.includes('onClick={openCategoryOverview}')],
  ['Category subsection no longer repeats current month', categoryHeading.includes('Największe kategorie') && !categoryHeading.includes('formatMonthLabel(monthKey)')],
