...
describe('1.2.0.39 month calendar readability', () => {
  it('keeps event counters neutral and high-contrast while preserving category dots', () => {
    ...
    expect(css).toContain('.calendar-day .category-count.category-study i { background: var(--category-study); }');
    expect(css).toContain('.calendar-day .category-count.category-personal i { background: var(--category-personal); }');
