      ...
      <div className="settings-dashboard-grid">
        <section className="panel settings-essential-card" aria-label="Najważniejsze ustawienia aplikacji">
          ...
          <div className="settings-build-line" aria-label={`Wersja ${APP_RELEASE_VERSION}, build ${BUILD_NUMBER}, schemat bazy ${DATABASE_SCHEMA_VERSION}, tryb lokalny`}>
            <span>Wersja {APP_RELEASE_VERSION}</span><i aria-hidden="true">·</i><span>Build {BUILD_NUMBER}</span><i aria-hidden="true">·</i><span>Baza {DATABASE_SCHEMA_VERSION}</span><i aria-hidden="true">·</i><span>Lokalnie</span>
          </div>
          <PwaInstallPanel />
        </section>
